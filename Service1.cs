...
{
    public partial class AllLifeDCService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                WriteTolog("-------------------  Starting Service -------------------", 1);
                WriteTolog("Setting Timer interval", 0);
        ...
        private void timer1_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                XML_ReadFile(System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "SQLServerList.xml");
        ...
        private void WriteTolog(string strMessage, int intforceLog)
        {
